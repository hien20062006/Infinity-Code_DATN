# Infinity Code-DATN
Đồ Án Tốt Nghiệp: Hệ Thống Phân Tích Ngành Điện Tử Việt Nam

Chào mừng bạn đến với kho lưu trữ mã nguồn của dự án Hệ thống Phân tích ngành điện tử Việt Nam. Đây là đồ án tốt nghiệp thiết kế và xây dựng một quy trình ELT (Extract - Load - Transform) nhằm thu thập, tích hợp, làm sạch và chuẩn hóa dữ liệu về hoạt động xuất khẩu, nhập khẩu và sản xuất ngành điện tử Việt Nam, đồng thời xây dựng Kho dữ liệu (Data Warehouse) phục vụ phân tích dữ liệu và báo cáo quản trị thông minh (Business Intelligence).
